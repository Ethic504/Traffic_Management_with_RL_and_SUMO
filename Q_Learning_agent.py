...
class Agent:
    def __init__(self, sumo_state, waitingTime):
    
        self.action_space_size = 4 # 4 traffic light 
        self.state_space_size = sumo_state
        q_table = np.zeros((self.state_space_size, self.action_space_size))
        #print(q_table)
        
        num_episodes = 1000             # number of episode
        max_steps_per_episode = 2000     # number of step per episode
